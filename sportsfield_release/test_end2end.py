...
def main():
    ...
    for i, data_batch in enumerate(test_loader):
        ...
        original_homography_list.append(util.to_numpy(orig_homography.data))
        optim_homography_list.append(util.to_numpy(optim_homography.data))
        gt_homography_list.append(util.to_numpy(gt_homography.data))
    t1 = time.time()
